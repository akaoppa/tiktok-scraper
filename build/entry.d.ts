...
import { Options, Result, UserMetadata, UserVideoMetadata, HashtagMetadata, HistoryItem, MusicMetadata } from './types';
...
export declare const getUserVideoInfo: (input: string, options?: Options) => Promise<UserVideoMetadata>;
